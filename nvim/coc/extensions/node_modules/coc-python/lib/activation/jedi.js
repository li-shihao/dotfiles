...
let JediExtensionActivator = class JediExtensionActivator {
    ...
    async activate(_resource) {
        ...
        context.subscriptions.push(coc_nvim_1.languages.registerCompletionItemProvider('jedi', 'JD', ['python'], new completionProvider_1.PythonCompletionItemProvider(jediFactory, this.serviceManager), ['.']));
